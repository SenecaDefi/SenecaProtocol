...
contract SenecaOracleWETH is IOracle {

    string oraclename = 'ETH Oracle';
    ...
    function _get() internal view returns (uint256) {
        ...
        ) = priceFeeds['ETH/USD'].latestRoundData();
    ...
    function updateOracle(address _oracle, string memory _key) public {
        require(msg.sender == owner, 'not owner');
        priceFeeds[_key] = AggregatorV3Interface(_oracle);
    }
}
